export const albumQueries = {
    ...
    readAlbumsByDescriptionSearch: 'SELECT id as albumId, title AS title, artist AS artist, description as description, year as year, image as image FROM music.albums WHERE music.albums.artist LIKE ?',
